...
class Department(BaseModel):
    ...
    departmentId: str = Field(..., description="The unique identifier of the department at The Met.")
...
class MuseumObject(BaseModel):
    ...
    objectId: str = Field(..., description="The unique identifier of the museum object.")
