...
class NotionAPI:
    ...
    def save_scenario(self) -> dict:
        ...
        return {
            "blocks": {block_id: block.dict() for block_id, block in self.blocks.items()},
            "pages": {page_id: page.dict() for page_id, page in self.pages.items()},
            "databases": {db_id: db.dict() for db_id, db in self.databases.items()},
