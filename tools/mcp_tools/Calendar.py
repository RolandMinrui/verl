...
class CalendarAPI:
    ...
    def save_scenario(self) -> dict:
        ...
        """
        return {
            "calendars": {k: v.dict() for k, v in self.calendars.items()},
            "events": {k: v.dict() for k, v in self.events.items()},
    ...
    def list_calendars(self) -> List[dict]:
        ...
        """
        return [calendar.dict() for calendar in self.calendars.values()]
    ...
    def list_events(self, calendar_id: Optional[str] = None, time_min: Optional[str] = None, 
        ...
        return [event.dict() for event in filtered_events]
    ...
    def search_events(self, query: str, calendar_id: Optional[str] = None, 
        ...
        return [event.dict() for event in matching_events]
