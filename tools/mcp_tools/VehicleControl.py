...
class VehicleControl:
    ...
    def save_scenario(self) -> dict:
        ...
        return {
            ...
            "door_status": self.door_status.dict() if self.door_status else None,
            "climate_status": self.climate_status.dict() if self.climate_status else None,
            ...
            "tire_pressure": self.tire_pressure.dict() if self.tire_pressure else None,
    ...
    def start_engine(self) -> dict:
        ...
        if self.door_status and all(status == "locked" for status in self.door_status.dict().values()):
    ...
    def get_door_status(self, door_position: Optional[str] = None) -> dict:
        ...
        door_dict = self.door_status.dict()
        if door_position:
    ...
    def get_tire_pressure(self, tire_position: Optional[str] = None) -> dict:
        ...
        tire_dict = self.tire_pressure.dict()
        if tire_position:
